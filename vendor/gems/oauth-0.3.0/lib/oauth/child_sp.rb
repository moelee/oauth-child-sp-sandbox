...
# Use this library to make calls to Auth SP to verify the validity of a received token
module OAuth
  class ChildSp
    ...
    @@default_options={
      ...
      # Verification path
      :verify_access_token_path =>'/oauth/verify_access_token'
    ...
    # Create a new ChildSp instance by passing it a configuration hash:
    #
    #   @access_token =OAuth::ChildSp.new( key,secret,{
    #     :site=>"http://term.ie",
    #     :scheme=>:header,
    #     :http_method=>:post,
    #     :verify_access_token_path=>"/oauth/example/verify_access_token.php"
    #    })
    #
    ...
    def verify_access_token_path
      @options[:verify_access_token_path]
    end
    
    # TODO this is ugly, rewrite
    def verify_access_token_url
      @options[:verify_access_token_url]||site+verify_access_token_path
    end
